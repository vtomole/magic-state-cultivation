...
### This file is lifted from the original MSC paper's Zenodo repository ###
...
class GidneyNoiseModel:
    ...
    @staticmethod
    def si1000(p: float) -> 'GidneyNoiseModel':
    ...
    @staticmethod
    def neutralatom(p: float) -> 'GidneyNoiseModel':
        """NAC inspired noise.
        """
        return GidneyNoiseModel(
            idle_depolarization=p / 10,
            additional_depolarization_waiting_for_m_or_r=p/10,
            any_clifford_1q_rule=NoiseRule(after={'DEPOLARIZE1': p / 10}),
            any_clifford_2q_rule=NoiseRule(after={'DEPOLARIZE2': p}),
            measure_rules={
                'Z': NoiseRule(after={'DEPOLARIZE1': 0},flip_result=p),
            },
            gate_rules={
    ...
    @staticmethod
    def uniform_depolarizing(p: float) -> 'GidneyNoiseModel':
    ...
    @staticmethod
    def cirq_uniform_depolarizing(p: float) -> 'GidneyNoiseModel':
        """Near-standard circuit depolarizing noise.
        ...
        return GidneyNoiseModel(
            ...
            any_clifford_2q_rule=NoiseRule(after={'DEPOLARIZE2': p}),
            measure_rules={
                'X': NoiseRule(after={'DEPOLARIZE1': 0}, flip_result=0),
                'Y': NoiseRule(after={'DEPOLARIZE1': 0}, flip_result=0),
                'Z': NoiseRule(after={'DEPOLARIZE1': 0}, flip_result=0),
                'XX': NoiseRule(after={'DEPOLARIZE2': 0}, flip_result=0),
                'YY': NoiseRule(after={'DEPOLARIZE2': 0}, flip_result=0),
                'ZZ': NoiseRule(after={'DEPOLARIZE2': 0}, flip_result=0),
            },
            gate_rules={
                'RX': NoiseRule(after={'Z_ERROR': p}),
                'RY': NoiseRule(after={'X_ERROR': p}),
    ...
    @staticmethod
    def depolarizing_two_body_measurement_noise(p: float) -> 'GidneyNoiseModel':
        return GidneyNoiseModel(
            idle_depolarization=p,
            any_clifford_1q_rule=NoiseRule(after={'DEPOLARIZE1': p}),
            measure_rules={
